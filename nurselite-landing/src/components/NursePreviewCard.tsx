  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        {/* Photo */}
        <div className="relative w-14 h-14 rounded-full overflow-hidden flex-shrink-0 border-2 border-[#4a9d9a]/20">
          {nurse.photoUrl ? (
            <Image
              src={nurse.photoUrl}
              alt={nurse.firstName}
          ...
          {/* Verified Badge */}
          {nurse.verified && (
            <div className="absolute -bottom-1 -right-1 w-5 h-5 bg-green-500 rounded-full flex items-center justify-center border-2 border-white dark:border-[#1e293b]">
