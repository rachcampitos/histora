...
const routes: Routes = [
  ...
  // ============================================================
  {
    ...
    children: [
      ...
      {
        path: 'complaints',
        loadChildren: () => import('./legal/complaints/complaints.module').then(m => m.ComplaintsPageModule),
      },
    ],
  },
  ...
  // ============================================================
  {
    ...
    loadChildren: () => import('./shared/notifications/notifications-list/notifications-list.module').then(m => m.NotificationsListPageModule),
  },
  {
