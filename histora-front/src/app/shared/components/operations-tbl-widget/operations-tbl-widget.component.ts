...
export class OperationsTblWidgetComponent {
  ...
  operationDataSource: Operation[] = [
    {
      patientImage: 'assets/images/user/user18.jpg',
    ...
    {
      patientImage: 'assets/images/user/user15.jpg',
    ...
    {
      patientImage: 'assets/images/user/user16.jpg',
    ...
    {
      patientImage: 'assets/images/user/user17.jpg',
    ...
    {
      patientImage: 'assets/images/user/user13.jpg',
    ...
    {
      patientImage: 'assets/images/user/user19.jpg',
    ...
    {
      patientImage: 'assets/images/user/user20.jpg',
    ...
    {
      patientImage: 'assets/images/user/user21.jpg',
